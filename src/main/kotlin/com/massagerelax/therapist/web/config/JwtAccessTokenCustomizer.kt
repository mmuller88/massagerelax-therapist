...
class JwtAccessTokenCustomizer @Autowired
constructor(private val mapper: ObjectMapper) : DefaultAccessTokenConverter(), JwtAccessTokenConverterConfigurer {
    ...
    override fun extractAuthentication(tokenMap: Map<String, *>): OAuth2Authentication {
        ...
        val request = OAuth2Request(oAuth2Request.requestParameters, oAuth2Request.clientId, authorities, true, oAuth2Request.scope,
                audienceList, null, null, null)

        val usernamePasswordAuthentication = UsernamePasswordAuthenticationToken(authentication.principal, "N/A", authorities)
    ...
    companion object {
        ...
        private val CLIENT_NAME_ELEMENT_IN_JWT = "resource_access"

        private val ROLE_ELEMENT_IN_JWT = "roles"
    }
